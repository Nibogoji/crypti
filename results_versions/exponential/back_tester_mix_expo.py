...
test_env = CustomEnv(ohlc, aap_data_5 , aap_data_10, Render_range=500,initial_balance=2000, base_bet=1500,retraining=20*48, training_size= training_size,lookback_window_size=lookback_window_size, prediction_horizon=(10,80))
