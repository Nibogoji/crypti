...
class CustomEnv:
    ...
    def __init__(self, df, aap_data5,aap_data10,
        ...
        self.quantity_space = [(i+1) for i in range(10)] #descrete bets space
    ...
    def step(self, action_5,plot_flag_5,action_10, plot_flag_10, tax = 0.001):
        ...
        # self.base_bet = self.net_worth*0.75
...
test_env = CustomEnv(ohlc, aap_data_5 , aap_data_10, Render_range=100,initial_balance=2000, base_bet=1500,retraining=20*48, training_size= training_size,lookback_window_size=lookback_window_size, prediction_horizon=(10,80))
