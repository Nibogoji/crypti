...
class TradingGraph:
    ...
    def render(self, Date, Open, High, Low, Close, net_worth, trades,pure_investment, ttd, filter, net_position, step_var, pcs_receipt):
        ...
        self.ax1.clear()
        candlestick_ohlc(self.ax1, self.render_data, colorup='green', colordown='red',width=0.8)
        ...
        self.ax4.clear()
        self.ax4.plot(Date_Render_range, self.net_position, label='Net Position MW')
        self.ax4.legend()
        for trade in trades:
