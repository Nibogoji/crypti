...
while page<2:
    ...
    try:
        ...
        traders = wallets[(wallets['Last Out'] > '2020-01-01') & (wallets['Number Of Outs'] > 10)]
    except:
        traders = []
        pass

    best_traders.append(traders)
    richWallet.append(wallets)
    wallets = walletlist[3]
    richWallet.append(wallets)
...
url = 'https://99bitcoins.com/bitcoin/rich-list/t99btc-rl-address'
...
import html5lib
df = pd.read_html('https://bitinfocharts.com/top-100-richest-bitcoin-addresses.html')

from urllib.request import Request, urlopen

req = Request('https://bitinfocharts.com/top-100-richest-bitcoin-addresses.html', headers={'User-Agent': 'Mozilla/5.0'})
